...
func _ready():
	# Asegúrate de que las monedas comiencen invisibles
	visible = false
...
func mostrar_monedas():
	# Lógica para mostrar las monedas cuando el cofre se abre
	visible = true
	do_animation()  # Si tienes una función de animación, puedes llamarla aquí
